...
const personas: PersonaConfig[] = [
    ...
    // 4. Senior Professional - ₹1L/month
    {
        ...
        goals: [
            { title: 'Retirement Fund', target: 10000000, current: 2500000, deadline: new Date('2040-01-01'), priority: 1 },
            { title: "Child's Education Fund", target: 2000000, current: 450000, deadline: new Date('2035-01-01'), priority: 2 },
            { title: 'Europe Trip', target: 500000, current: 150000, deadline: new Date('2026-05-01'), priority: 3 },
        ],
    ...
    // 5. Retiree - ₹40K/month (pension)
    {
        ...
        goals: [
            { title: 'Medical Emergency Fund', target: 500000, current: 350000, deadline: new Date('2026-12-31'), priority: 1 },
            { title: "Grandchild's Birthday Gift", target: 50000, current: 40000, deadline: new Date('2026-03-01'), priority: 2 },
        ],
